...
namespace BiitProjectProgessSystemApi.Controllers
{
    public class UserController : ApiController
    {
        ...
        private DataTable getUserjsonResponse(int status, String message, user obj)
        {
            ...
            dt_1.Columns.Add("profile_pic");

            dt_1.Rows.Add(obj.id,obj.name,obj.email,obj.username,obj.platform,obj.group_id,obj.role_id,obj.phone,obj.address,obj.is_allowed_in_meeting,obj.profile_pic);
